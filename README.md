...
- Create an ERC721 token contract. You can use [this implementation](https://github.com/OpenZeppelin/cairo-contracts/blob/v0.3.1/src/openzeppelin/token/erc721/presets/ERC721MintableBurnable.cairo) as a base
