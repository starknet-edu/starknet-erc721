...
mod TDERC20 {
    ...
    // Internal Imports
    use starknet_erc721::token::ERC20_base::ERC20Base::ERC20_name;
    use starknet_erc721::token::ERC20_base::ERC20Base::ERC20_symbol;
    use starknet_erc721::token::ERC20_base::ERC20Base::ERC20_totalSupply;
    use starknet_erc721::token::ERC20_base::ERC20Base::ERC20_decimals;
    use starknet_erc721::token::ERC20_base::ERC20Base::ERC20_balanceOf;
    use starknet_erc721::token::ERC20_base::ERC20Base::ERC20_allowance;
    use starknet_erc721::token::ERC20_base::ERC20Base::ERC20_mint;
    use starknet_erc721::token::ERC20_base::ERC20Base::ERC20_burn;
    use starknet_erc721::token::ERC20_base::ERC20Base::ERC20_initializer;
    use starknet_erc721::token::ERC20_base::ERC20Base::ERC20_approve;
    use starknet_erc721::token::ERC20_base::ERC20Base::ERC20_increaseAllowance;
    use starknet_erc721::token::ERC20_base::ERC20Base::ERC20_decreaseAllowance;
