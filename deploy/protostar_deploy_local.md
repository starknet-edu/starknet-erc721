...
protostar -p devnet deploy 0x0015b1abb9eb21e540a1c7550648837d5eec1481fa5ec112c30724f532be553e --account-address 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919 --private-key-path ./.pkey_local --max-fee auto -i 327360763727160756219953 327360763727160756219953 0 0 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919
...
protostar -p devnet deploy 0x05db7eb921593a29e41ec904de97b7f69db02a532da935b06a3c8f2678512971 --account-address 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919 --private-key-path ./.pkey_local --max-fee auto -i 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919
```

## Deploy dummy token
```
protostar -p devnet declare ./build/dummy_token.json --account-address 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919 --private-key-path ./.pkey_local --max-fee auto

protostar -p devnet deploy 0x05fee25dd4509206023b8152c666071b7062be7994cb02774a83e5798a2227bc --account-address 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919 --private-key-path ./.pkey_local --max-fee auto -i 323287074983686041199982 4478027 100000000000000000000 0 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919

protostar -p devnet call --contract-address 0x01f8c9352a4abe221410102bb2b50c1632a3f1a848e99daca15d8e24c2f2a917 --function "balanceOf" --inputs 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919
```

## Deploy dummy ERC721
```
protostar -p devnet declare ./build/TDERC721_metadata.json --account-address 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919 --private-key-path ./.pkey_local --max-fee auto

protostar -p devnet deploy 0x006e4142da0432bfd1d0b08ab6ad35540411a08c8ed835ada1247e682b0d687e --account-address 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919 --private-key-path ./.pkey_local --max-fee auto -i 6072054417219596849 6072054417219596849 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919 3 184555836509371486644298270517380613565396767415278678887948391494588524912 181013377130045435659890581909640190867353010602592517226438742938315085926 2194400143691614193218323824727442803459257903 199354445678
...
## Deploy Evaluator
```
protostar -p devnet declare ./build/Evaluator.json --account-address 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919 --private-key-path ./.pkey_local --max-fee auto
...
```
protostar -p devnet invoke --contract-address 0x045a79a4f454c474ee6905b6b79a8c72d99fd593aea34ca2c6d6214249442801 --account-address 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919 --function "finish_setup" --max-fee auto --private-key-path ./.pkey_local
```

## Set evaluator as admin in ERC20
```
protostar -p devnet invoke --contract-address 0x07b12625c751f82ca98838311eae7e77c96f45f6898b9cb1d971522b75a48474 --function "set_teacher" --account-address 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919 --inputs 0x045a79a4f454c474ee6905b6b79a8c72d99fd593aea34ca2c6d6214249442801 1 --max-fee auto --private-key-path ./.pkey_local
...
```
protostar -p devnet invoke --contract-address 0x03bafb663a73882f8d88bad3f922f88f8e2d099d90a5817464577d321aa14bc4 --function "set_exercise_or_admin" --account-address 0x33507ff2edf12c12c73d0b6d1d90de9fac12a355de1097ab305249612451919 --inputs 0x045a79a4f454c474ee6905b6b79a8c72d99fd593aea34ca2c6d6214249442801 1 --max-fee auto --private-key-path ./.pkey_local
